...
class EnhancedRSVDUCBThompson:
    ...
    def load_server_data_skewed(self, alpha=0.1, n_server_samples=4000, retained_classes=30, batch_size=10):
        ...
        for cid in selected_clients:
            ...
            if reward > 0.9:
                ...
                if self.anomaly_score_history[cid] <= self.poisoned_threshold * 0.5:
                    if self.selection_counts[cid] > 5:  # New condition
