...
class EnhancedRSVDUCBThompson:
    def __init__(self, num_clients, num_join_clients, server_data_path, min_valid_clients=10, c=1, prior_alpha=1, prior_beta=1):
        ...
        self.train_loader = DataLoader(self.server_data, batch_size=10, drop_last=True, shuffle=True)
    ...
    def load_server_data(self):
        ...
        train_loader = DataLoader(self.server_data, batch_size=10, drop_last=False, shuffle=True)
